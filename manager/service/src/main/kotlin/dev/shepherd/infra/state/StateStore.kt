...
object Sessions : Table("sessions") {
    ...
    val apiLevel = varchar("api_level", 10)
...
class StateStore(dbPath: String) {
    ...
    init {
        ...
        transaction {
            SchemaUtils.create(Sessions, SessionLeases)
        }
    ...
    private fun rowToSession(row: org.jetbrains.exposed.sql.ResultRow): Session {
        return Session(
            ...
            apiLevel = row[Sessions.apiLevel],
